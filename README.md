...
- 주문상태 확인 
```
gitpod /workspace/food-delivery (main) $ http :8084/infos/1
HTTP/1.1 200 
Connection: keep-alive
Content-Type: application/hal+json
Date: Mon, 27 Mar 2023 02:00:26 GMT
Keep-Alive: timeout=60
Transfer-Encoding: chunked
Vary: Origin
Vary: Access-Control-Request-Method
...

{
    "_links": {
        "info": {
            "href": "http://localhost:8084/infos/1"
        },
        "self": {
            "href": "http://localhost:8084/infos/1"
        }
...
```
# 3. Compansation/Correlation
```
gitpod /workspace/food-delivery (main) $ http :8084/infos/1
HTTP/1.1 200 
Connection: keep-alive
Content-Type: application/hal+json
Date: Mon, 27 Mar 2023 02:17:13 GMT
Keep-Alive: timeout=60
Transfer-Encoding: chunked
Vary: Origin
Vary: Access-Control-Request-Method
...
gitpod /workspace/food-delivery (main) $ http PATCH :8081/orders/9 status=cancel
HTTP/1.1 200 
Connection: keep-alive
Content-Type: application/json
Date: Mon, 27 Mar 2023 02:17:36 GMT
Keep-Alive: timeout=60
Transfer-Encoding: chunked
Vary: Origin
Vary: Access-Control-Request-Method
...
Connection: keep-alive
Content-Type: application/hal+json
Date: Mon, 27 Mar 2023 02:17:40 GMT
Keep-Alive: timeout=60
Transfer-Encoding: chunked
Vary: Origin
Vary: Access-Control-Request-Method
